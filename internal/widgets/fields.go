...
var fieldsByType = map[string][]Field{
	...
	"kpi": {sel("metric", "hours_today", "hours_today", "hours_week", "hours_month", "utilization", "unbilled",
		...
		"asset_value", "assets_ready", "revenue_forecast", "cash_30")},
	"table": {sel("table", "open_invoices", "open_invoices", "unbilled", "budgets", "client_shares", "asset_dates", "trips"),
		{Key: "limit", Input: InputNumber, Default: 8}},
	"chart":     {sel("chart", "revenue", "revenue", "hours"), {Key: "months", Input: InputNumber, Default: 12}},
